...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.eFormRentableItemBase/Microting.eFormRentableItemBase.csproj package Microting.eForm
	dotnet add Microting.eFormRentableItemBase/Microting.eFormRentableItemBase.csproj package Microting.eFormApi.BasePn
