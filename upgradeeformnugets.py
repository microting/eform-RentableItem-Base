...
def main():
    ...
    if int(get_git_status()) > 0:
        ...
        os.chdir("Microting.eFormRentableItemBase")
        ...
        process_repository('Microting.eFormRentableItemBase.csproj', packages, 'eform-RentableItem-Base')
        ...
        if new_number_of_commits > current_number_of_commits:
            ...
            os.chdir("..")
            run_command(f"github_changelog_generator -u microting -p eform-RentableItem-Base -t {os.getenv('CHANGELOG_GITHUB_TOKEN')}", shell=True)
